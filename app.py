...
app = Flask(__name__)
# Vercel-এ সেশন স্ট্যাবিলিটির জন্য শক্তিশালী সিক্রেট কী
app.secret_key = "SB_SAKIB_ULTRA_PRO_VERSION_99"
...
<head>
    ...
    <style>
        ...
        .btn-del { background: var(--danger); color: #fff; padding: 5px 10px; border-radius: 4px; text-decoration: none; font-size: 12px; float: right; margin-left: 10px; border:none; cursor:pointer;}
...
<body>
    ...
    <div class="container">
        ...
        {% elif page == 'dash' %}
            ...
            {% endfor %}
            <p style="text-align: center;"><a href="/logout" style="color: var(--danger); text-decoration: none;">Logout</a></p>
        {% elif page == 'edit' %}
            <div class="card" style="max-width: 500px; margin: 50px auto;">
                <h3>EDIT PARAMETERS</h3>
                <form method="POST">
                    <input type="text" name="p_key" value="{{ api.params.key }}" placeholder="JSON Key" required>
                    <input type="text" name="p_val" value="{{ api.params.val }}" placeholder="New Value" required>
                    <button type="submit">SAVE CHANGES</button>
                </form>
                <br><a href="/admin" style="color: #888; text-decoration: none;">← Cancel</a>
            </div>
        {% endif %}
    </div>
</body>
